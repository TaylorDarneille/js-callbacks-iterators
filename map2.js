...
//Your code here
const addCountryCode = (obj) => {
  const phoneNumber = obj[Object.keys(obj)[0]];
  const countryCode = phoneNumber.charAt(0);
  obj[Object.keys(obj)[0]] = countryCode + '-' + phoneNumber;
  return obj;
}

const newPhoneBook = phoneBook.map(addCountryCode);
console.log(newPhoneBook);

//*googled mozilla.developer for object.keys and charAt